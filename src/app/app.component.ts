...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'BarcodescannerPage', component: BarcodescannerPage, icon : 'md-expand' },
      { title: 'Geolocation', component: GMapPage, icon : 'md-pin'},
      { title: 'JsonMenu', component: JsonMenuPage, icon : 'md-reorder'}
    ];
